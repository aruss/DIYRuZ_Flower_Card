...
customElements.define('action-handler-flower', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-flower')) {
    return body.querySelector('action-handler-flower') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-flower');
